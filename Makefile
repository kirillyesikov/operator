...
# kirillesikov.atwebpages.com/operator-bundle:$VERSION and kirillesikov.atwebpages.com/operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= kirillesikov.atwebpages.com/operator
